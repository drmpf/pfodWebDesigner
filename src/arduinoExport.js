        ...
        try {
            ...
            .then(drawingData => {
               ...
               filesToZip.push({filename: `/json/${drawingName}.json`, content: JSON.stringify(drawingData,null,2)});
                ...
                if (isMain) {
                 filesToZip.push({filename: `pfodMainDrawing.h`, content: pfodMainDrawing_H(drawingName)});
                }
...
`;
  arduinoCode +=`
extern pfodDrawing dwg_${dwgName};  // the main drawing defined in Dwg_${dwgName}.cpp
